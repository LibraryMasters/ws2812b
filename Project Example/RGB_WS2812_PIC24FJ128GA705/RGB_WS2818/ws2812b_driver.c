...
uint8_t ws2812b_write_basic_color(ws2812b_handle_t *handle, ws2812b_basic_color_t color) {
    ...
    uint8_t green = 255, red = 255, blue = 255;
 ...
 * @note   none
 */
uint8_t ws2812b_write_color(ws2812b_handle_t *handle, uint16_t led_count, uint8_t color[]) {
...
uint8_t ws2812b_led_clear(ws2812b_handle_t *handle, uint16_t ledCount) {
    ...
    volatile uint16_t count; /*<< number of RGB on the array*/
