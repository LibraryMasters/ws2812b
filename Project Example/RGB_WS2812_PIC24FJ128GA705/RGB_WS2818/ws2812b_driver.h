...
#define WS2812b_RESET_TIMEOUT  (int8_t)10U /**< wait at least 1ms to reset*/
    ...
    typedef enum {
        ...
        WS2812b_COLOR_CLEAR = 7,
        WS2812b_COLOR_PURPLE = 8
...
#define DRIVER_WS2812b_LINK_DEBUG_PRINT(HANDLE, FUC)           (HANDLE)->debug_print = FUC
     ...
     * @note   none
     */
    uint8_t ws2812b_write_color(ws2812b_handle_t *handle, uint16_t led_count, uint8_t color[3]);
    ...
    uint8_t ws2812b_led_clear(ws2812b_handle_t *handle, uint16_t ledCount);
